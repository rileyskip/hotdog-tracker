...
const HotdogForm: React.FC<HotdogFormProps> = ({ addHotdog }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mb-6">
      <h2 className="text-4xl font-semibold mb-4 text-center">Add Hotdogs</h2>
      <form onSubmit={handleSubmit} className="flex items-end justify-center space-x-4 max-w-md mx-auto">
